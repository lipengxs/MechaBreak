        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/guides/map" className="text-gray-400 hover:text-white transition-colors">
                  Map
                </Link>
              </li>
              <li>
                <Link href="/guides/strikers" className="text-gray-400 hover:text-white transition-colors">
                  Strikers
                </Link>
              </li>
              <li>
                <Link href="/guides/airdrops" className="text-gray-400 hover:text-white transition-colors">
                  Airdrops
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://twitter.com/mechabreak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://www.youtube.com/mechabreak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                ...
                <a href="https://discord.gg/mechabreak" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
